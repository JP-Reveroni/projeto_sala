...
{
    /*
    Validação dos codigos de erro
    0 - Erro de exceção
    1 - Operação realizada no banco de dados com sucesso(Inserção, Alteração, Consulta ou exclusão)
    8 - Houve algum problema de inserção, atualização, consula ou exclusão
    ...
    */
    ...
    public function consultar($codigo, $descricao, $capacidade, $dataInicio)
    {
        try {
            ...
            $sql = "select codigo, descricao, capacidade, dataInicio, date_format(dataInicio, '%d-%m-%Y') dataIniciobra from tbl_turma where estatus = '' ";
    ...
    {
        try {
            //Query para consultar dados de acordo com o que foi passado nos parametros
        ...
        //Envia o array $dados com as info tratadas acima pela estrutura if
        return $dados;
    }
    ...
    public function desativar($codigo)
    {
        try {
            ...
            if ($retornoConsulta['codigo'] == 10) {
                ...
                //Verifica se ocorreu com sucesso
                if ($this->db->affected_rows() > 0) {
                    $dados = array(
                        'codigo' => 1,
                    ...
                    $dados = array(
                        'codigo' => 8,
                        'msg' => 'Houve algum problema na DESATIVAÇÂO da turma.'
                    );
                }
