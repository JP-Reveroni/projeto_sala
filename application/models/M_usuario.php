...
class M_usuario extends CI_Model {
    ...
    4 - Usuário não validado sistema
            ...
            if($retornoUsuario['codigo'] == 4){
                ...
                if($this->db->affected_rows() > 0){
                    ...
                    $dados = array('codigo' => 8,
                                   'msg' => 'Houve algum problema na inserção na tabela
                                        de usuário.');
                }
            }else{
        ...
        try{
            ...
            if($retornoUsuario['codigo'] == 1){
                ...
                if($this->db->affected_rows() > 0){
                    ...
                    $dados = array('codigo' => 8,
                                   'msg' => 'Houve algum problema na atualização na tabela de usuarios');
                }
            }else{
                $dados = array('codigo' => $retornoUsuario['codigo'],
                               'msg' => $retornoUsuario['msg']);
        ...
        try{
            ...
            if($retornoUsuario['codigo'] == 1){
                ...
                if($this->db->affected_rows() > 0){
                    ...
                    $dados = array('codigo' => 8,
                                   'msg' => 'Houve algum problema na DESATIVAÇAO
                                        do usuário');
                }
            }else{
                $dados = array('codigo' => $retornoUsuario['codigo'],
